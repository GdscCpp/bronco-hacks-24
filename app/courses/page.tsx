        ...
        <>
            <div className="flex-1 justify-start h-ful bg-primary-900 p-[25px] ml-[15px] rounded-xl">
                ...
                <div className="grid grid-cols-3 gap-4">
                    {courses.map((course) => {
                        return (
                            <div className="bg-primary-500 h-[250px] rounded-xl flex flex-col justify-end p-4 " style={{backgroundImage: `url(${course.bg_image})`}} onClick={() => router.push(`/courses/${course.id}`)}>
            ...
            <div className="w-[400px] ml-[15px] flex flex-col">
                ...
                <div className="w-full flex-1 overflow-y-scroll no-scrollbar rounded-xl bg-primary-900 p-[25px]">
                    <h1 className="text-2xl text-secondary-500 mb-5"><FontAwesomeIcon icon={faBook} className="mr-2"></FontAwesomeIcon> Due Soon</h1> 
                    ...
                    <h1 className="text-2xl text-secondary-500 mb-5"><FontAwesomeIcon icon={faPencil} className="mr-2"></FontAwesomeIcon> To Do</h1> 
                    {assignments.map((assignment) => {
                        if(moment(assignment.due_at).diff(moment(), 'days') > 7)
                            return (
                                <div className="w-full p-3 text-white bg-primary-400 rounded-xl mb-5">
